 ...
 * @author Frank
 */
public class addDandPAT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel15.setBounds(0, 76, 560, 19);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addDandPAT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addDandPAT().setVisible(true);
            }
        });
    }
