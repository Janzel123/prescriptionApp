...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2024 at 11:35 AM
...
(103, 'Nicole Pellerin', 'nicole@email.com', 'nicole', '12345', 'Frontdesk');
...
--
ALTER TABLE `tbl_patient`
  MODIFY `p_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;

--
-- AUTO_INCREMENT for table `tbl_prescription`
--
ALTER TABLE `tbl_prescription`
  MODIFY `pr_id` int(50) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_appointment`
  ADD CONSTRAINT `tbl_appointment_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `tbl_user` (`u_id`),
